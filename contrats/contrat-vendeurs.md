...
# 1-2 Très bien oui adapte le contrat comme ça et donne le moi en point .MD Ajoute l'option 3 "Ajouter une phrase sur “activation du lien”" C'est bien aussi

Oui : tu peux faire signer le contrat d’abord, puis demander la connexion du compte de paiement/IBAN ensuite, à condition de prévoir contractuellement que le versement des commissions peut être **suspendu** tant que les exigences de vérification et/ou les infos de paiement ne sont pas complétées.[^1][^2]

```md
# CONTRAT D’APPORTEUR D’AFFAIRES (MISE EN RELATION UNIQUEMENT)
Version : <<EDIT: VERSION_CONTRAT>> (ex : v1.0)
...
### 1) La Société
Dénomination : <<EDIT: SOCIETE_DENOMINATION>> (ex : KAISER CO)  
Forme : <<EDIT: SOCIETE_FORME>> (ex : Entrepreneur individuel – Micro-entreprise)  
Siège social : <<EDIT: SOCIETE_ADRESSE>>  
SIRET : <<EDIT: SOCIETE_SIRET>>  
TVA intracommunautaire (si applicable) : <<EDIT: SOCIETE_TVA>>  
Représentée par : <<EDIT: REPRESENTANT_NOM>>, en qualité de <<EDIT: REPRESENTANT_QUALITE>>  

Ci-après dénommée « la Société »

### 2) L’Apporteur d’affaires
Nom / Prénom ou Raison sociale : <<EDIT: APPORTEUR_NOM>>  
Adresse : <<EDIT: APPORTEUR_ADRESSE>>  
Email : <<EDIT: APPORTEUR_EMAIL>>  
Téléphone (optionnel) : <<EDIT: APPORTEUR_TEL>>  

Statut : <<EDIT: APPORTEUR_STATUT>> (Micro-entreprise / Société / EI / Particulier)  
SIRET (si applicable) : <<EDIT: APPORTEUR_SIRET>>  
TVA intracommunautaire (si applicable) : <<EDIT: APPORTEUR_TVA>>  
Assujetti à TVA : <<EDIT: APPORTEUR_TVA_OUI_NON>>  
...
## PRÉAMBULE
La Société édite et commercialise une plateforme web destinée aux restaurants professionnels, accessible à l’adresse <<EDIT: URL_PLATEFORME>> (ci-après la « Plateforme »), proposant des services de gestion d’avis clients et de réputation en ligne.
...
<<EDIT: FORMAT_LIEN_PARRAINAGE>> (ex : https://app.vraisavis.fr/register?ref=CODE)
...
Le taux de commission Année 1 est fixé à **<<EDIT: TAUX_COMMISSION_ANNEE1>>** % HT (ex : 50%) du montant HT de l’abonnement mensuel payé par le client, uniquement sur les paiements effectivement et définitivement encaissés.
...
Plafond total de commission Année 1 par client : <<EDIT: PLAFOND_ANNEE1_PAR_CLIENT>> € HT (optionnel).
...
### 4.7 Taux Année 2
Le taux de Prime de longévité Année 2 est fixé à **<<EDIT: TAUX_PRIME_ANNEE2>>** % HT (ex : 50%) du montant HT de l’abonnement mensuel payé par le client, uniquement sur les paiements effectivement et définitivement encaissés.
...
Durée : pendant le contrat et <<EDIT: DUREE_CONFIDENTIALITE_ANNEES>> ans après sa cessation (ex : 2).
...
Chaque Partie peut résilier à tout moment avec un préavis de <<EDIT: PREAVIS_JOURS>> jours calendaires (ex : 30), par notification (article 14), sous réserve des dispositions impératives applicables.

### 8.3 Résiliation pour faute
En cas de manquement grave, résiliation possible après mise en demeure restée sans effet pendant <<EDIT: DELAI_MISE_EN_DEMEURE_JOURS>> jours (ex : 15), sans indemnité.
...
Sauf faute lourde/intentionnelle, la responsabilité totale de chaque Partie est limitée au total des commissions/primes versées sur les <<EDIT: PLAFOND_RESPONSABILITE_MOIS>> derniers mois (ex : 12) précédant le fait générateur.
...
Pour la Société : <<EDIT: EMAIL_SOCIETE>> ; <<EDIT: ADRESSE_SOCIETE_NOTIF>>  
Pour l’Apporteur : <<EDIT: APPORTEUR_EMAIL>> ; <<EDIT: APPORTEUR_ADRESSE>>
...
Tentative amiable sous <<EDIT: DELAI_AMIABLE_JOURS>> jours (ex : 30).  
À défaut : tribunaux compétents de <<EDIT: VILLE_JURIDICTION>> (ex : Paris), sous réserve des dispositions impératives applicables.

---

## SIGNATURES
Fait à <<EDIT: VILLE_SIGNATURE>>, le <<EDIT: DATE_SIGNATURE>>, en deux exemplaires.

Pour la Société  
Nom : <<EDIT: REPRESENTANT_NOM>>  
Qualité : <<EDIT: REPRESENTANT_QUALITE>>  
Signature : _______________________

Pour l’Apporteur  
Nom : <<EDIT: APPORTEUR_NOM>>  
Signature : _______________________
...
Identité :
- Nom / Raison sociale : <<EDIT: APPORTEUR_NOM>>
- Adresse : <<EDIT: APPORTEUR_ADRESSE>>
- Email : <<EDIT: APPORTEUR_EMAIL>>
- Statut : <<EDIT: APPORTEUR_STATUT>>
- SIRET (si applicable) : <<EDIT: APPORTEUR_SIRET>>
...
Si tu veux, je peux aussi te fournir une version “diff” (liste des passages supprimés/ajoutés) pour que tu voies exactement où la partie “Stripe” a été remplacée par la clause générique.

<div align="center">⁂</div>

[^1]: https://docs.stripe.com/connect/identity-verification?locale=fr-FR

[^2]: https://docs.stripe.com/connect/custom/onboarding
