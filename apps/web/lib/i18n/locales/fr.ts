...
export const fr: Translations = {
  ...
  contactPhonePlaceholder: '06 12 34 56 78',
  ...
  // Claim - choice
  claimTitle: 'Votre cadeau',
  claimPrizeLabel: 'Félicitations ! Vous avez gagné :',
  ...
  claimNowTitle: 'Présentez au serveur',
  claimWarning: '⚠️ Attention ! Si vous appuyez sans responsable, votre lot sera perdu.',
