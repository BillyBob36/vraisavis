...
export default function SlotMachine({
  ...
  }, [stopped, isSpinning, onSpinComplete]);
  ...
  return (
    <div className="w-full max-w-sm mx-auto">
      ...
      <div className={`rounded-2xl p-6 ${
        ...
        {/* Reels */}
        <div className={`flex justify-center gap-2 p-4 rounded-xl mb-4 ${
          isGlass 
          ...
          {[0, 1, 2].map(reelIdx => (
            <div
              key={reelIdx}
              className={`w-20 h-24 flex items-center justify-center rounded-lg text-5xl transition-transform ${
            ...
            >
              <span className={spinning[reelIdx] ? 'animate-bounce' : 'transition-all duration-300'}>
        ...
        <div className={`mt-4 rounded-xl p-4 ${
          ...
          <div className="space-y-2">
            {prizes.map(prize => {
              ...
              return (
                <div key={prize.id} className={`flex items-center gap-3 p-2 rounded-lg ${
